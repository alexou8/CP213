...
public class BST<T extends Comparable<T>> {
	...
	boolean leftValid = isValidAux(node.getLeft(), minNode, node);
	boolean rightValid = isValidAux(node.getRight(), node, maxNode);
	...
	while (node != null) {
	    ...
	    int value = key.compareTo(node.getCountedEntity());
